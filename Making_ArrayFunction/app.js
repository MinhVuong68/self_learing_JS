// function NhanVien(name,address){
//     this.name = name;
...
//     let nv = new NhanVien(fullName,address);
//     listNV.push(nv);
//     render();
//     clean();
...
//         row += '<tr> <td> '+listNV[i].name+' </td><td>'+listNV[i].address+'</td><td><button class="btnXoa" onclick="deleteItem('+i+');">Delete</button><button class="btnUpdate" onclick="updateItem('+i+');">Update</button></td></tr>'
        
//     }
//     document.getElementById("contentTable").innerHTML = row;
// }
...
//     document.getElementById("txtName").value = listNV[index].name;
//     document.getElementById("txtDiaChi").value = listNV[index].address;
